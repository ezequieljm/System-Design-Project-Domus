...
function SearchFieldAndWindowModal({setEntryUser, handleOpen, handleClose, entryUser, open}) {
  ...
  return(
    <form action="">
      <div style={{padding: '1rem'}}>
        <TextField label="Nombre" variant="outlined" disabled defaultValue={clientData.firtsname} style={{marginRight: '2rem'}}/>
        <TextField label="Apellido" variant="outlined" disabled defaultValue={clientData.surname} style={{marginRight: '2rem'}}/>
        <TextField label="DNI" variant="outlined" disabled defaultValue={clientData.dni}/>
      </div>
      <div style={{padding: '1rem'}}>
        <TextField label="CUIL/CUIT" variant="outlined" disabled defaultValue={clientData.cuitCuil} style={{marginRight: '2rem'}}/>
        <TextField label="Nacimiento" variant="outlined" disabled defaultValue={clientData.dateOfBirth} style={{marginRight: '2rem'}}/>
      <TextField label="Teléfono" variant="outlined" disabled defaultValue={clientData.cellPhone}/>
      </div>
      <div style={{padding: '1rem'}}>
        <TextField label="Email" variant="outlined" disabled defaultValue={clientData.email}/>
      </div>
    </form>
  )
}
  ...
  return (
    <>
      <div style={{marginBottom: '.5rem', padding: '1rem'}}>
        <Typography variant="h6">1. Seleccione un día y horario para la cita</Typography>
        <DatePickerCustom setDay={setDay}/>
      </div>
      <div style={{marginBottom: '.5rem', padding: '1rem'}}>
        <Typography variant="h6">2. Seleccione un agente inmobiliario</Typography>
        <SelectHouseAgent dayAvailable={day}/>
      </div>
      <div style={{marginBottom: '.5rem', padding: '1rem'}}>
        <Typography variant="h6">3. Ingrese el código de al propiedad</Typography>
        <TextField
          label="Propiedad"
