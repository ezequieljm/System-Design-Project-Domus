        ...
        <form action="" className={classes.form} >
          <div className={classes.divsContent}>
            <FormControl required fullWidth focused>
              ...
              <Input id="input-name" aria-describedby="my-helper-text" type="text" defaultValue={dbUsers[0].razónSocial}/>
          ...
          <div className={classes.divsContent}>
            <FormControl required  fullWidth focused>
              ...
              <Input id="input-surname" aria-describedby="my-helper-text" type="text" defaultValue={dbUsers[0].firtsname + " " + dbUsers[0].surname}/>
          ...
          <div className={classes.divsContent}>
            <FormControl required fullWidth style={{marginRight: '2rem'}} focused>
              ...
              <Input id="input-cuit-cuil" aria-describedby="my-helper-text" type="text" defaultValue={dbUsers[0].cuitCuil}/>
              <FormHelperText id="my-helper-text">CUIL/CUIT del Cliente.</FormHelperText>
            </FormControl>
            <FormControl required fullWidth focused>
              <InputLabel htmlFor="my-input">Teléfono</InputLabel>
              <Input id="input-phone" aria-describedby="my-helper-text" type="text" defaultValue={dbUsers[0].cellPhone}/>
          ...
          <div className={classes.divsContent}>
            <FormControl required fullWidth focused>
              ...
              <Input id="input-email" aria-describedby="my-helper-text" type="email" fullWidth defaultValue={dbUsers[0].email} />
          ...
          <div className={classes.divsContent}>
            <FormControl required fullWidth style={{marginRight: '2rem'}} focused>
              ...
              <Input id="input-birth" aria-describedby="my-helper-text" type="text"  defaultValue={dbUsers[0].address} />
            ...
            <FormControl required fullWidth focused>
              ...
              <Input id="input-house-agent" aria-describedby="my-helper-text" type="email" fullWidth defaultValue={dbUsers[0].houseAgent}/>
