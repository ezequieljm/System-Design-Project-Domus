...
function Row(props) {
  ...
  const setColorStateText = state => state === 'En Proceso' ? classes.pending : state === "Finalizada" ? classes.fulfilled : classes.rejected; 
  return (
    <React.Fragment>
      ...
      <TableRow>
        <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={6}>
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Box margin={1}>
              <Typography variant="h6" gutterBottom component="div" className={setColorStateText(row.history[0].stateActiviti)}>
